...
QT_MOC_LITERAL(5, 51, 11), // "addWaypoint"
QT_MOC_LITERAL(6, 63, 14), // "deleteWaypoint"
QT_MOC_LITERAL(7, 78, 3), // "row"
QT_MOC_LITERAL(8, 82, 12), // "startMission"
QT_MOC_LITERAL(9, 95, 9), // "clearLogs"
QT_MOC_LITERAL(10, 105, 8), // "saveLogs"
QT_MOC_LITERAL(11, 114, 15), // "updateTelemetry"
QT_MOC_LITERAL(12, 130, 12), // "updateOutput"
QT_MOC_LITERAL(13, 143, 4) // "text"

    },
    "UAVFleetGUI\0startSimulation\0\0armUAVs\0"
    "sendSetpoints\0addWaypoint\0deleteWaypoint\0"
    "row\0startMission\0clearLogs\0saveLogs\0"
...
void UAVFleetGUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->deleteWaypoint((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->startMission(); break;
        case 6: _t->clearLogs(); break;
        case 7: _t->saveLogs(); break;
        case 8: _t->updateTelemetry(); break;
        case 9: _t->updateOutput((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
